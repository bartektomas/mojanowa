...
*/
 ...
 Route::group(array('domain' => '{name}.'.Config::get('database.domain')), function(){
    ...
    Route::get('/', array('as' => 'publicblog', 'uses' => 'BlogController@publicBlog'))->before('checkdomain');

    Route::get('follow/{blog_id}', array('as' => 'follow', 'uses' => 'UserController@follow'))->before('checkdomain');

    Route::get('unfollow/{blog_id}', array('as' => 'unfollow', 'uses' => 'UserController@unfollow'))->before('checkdomain');
