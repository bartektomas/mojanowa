    ...
    <div class="newsfeed" >
      ...
      <div class="feed clearfix" >
        <div class="avatar no-nip" >
          <a href="http://{{$sender->name}}.rumblr.com" >
        ...
        <div class="fanmail" >
          ...
          <div class="footer" >
            ...
            <div class="options" >
              <div id="reply" data-sender="{{$sender->name}}" style="cursor: pointer;display: inline" data-toggle="modal" data-target="#fanmailreply"> <i class="glyphicon glyphicon-share-alt" ></i> </div>
              <a href="{{URL::route('deletemessage', array('id' => $message->id))}}" > <i class="glyphicon glyphicon-trash" ></i > </a >
            </div >
          </div >
        </div >
      </div >
