...
<div class="avatar" >
  ...
  <a href="{{URL::route('publicblog', array('name' => $defaultblog['name']))}}" >
...
<ul id="trigger" class="post-triggers" >
  <li >
    <a href="javascript:;" id="text-trigger" >
      <i class="glyphicon glyphicon-font black" ></i >
      <span > Text </span >
    </a >
  </li >
  <li >
  ...
  <li >
    <a href="javascript:;" id="quote-trigger" >
      <i class="glyphicon glyphicon-bullhorn orange" ></i >
      <span > Quote </span >
    </a >
  </li >
  <li >
    <a href="javascript:;" id="link-trigger" >
      <i class="glyphicon glyphicon-link light-green" ></i >
      <span > Link </span >
    </a >
  </li >
  <li >
    <a href="javascript:;" id="chat-trigger" >
      <i class="glyphicon glyphicon-comment light-blue" ></i >
      <span > Chat </span >
    </a >
  </li >
  <li >
    <a href="javascript:;" id="audio-trigger" >
      <i class="glyphicon glyphicon-headphones violet" ></i >
      <span > Audio </span >
    </a >
  </li >
  <li >
    <a href="javascript:;" id="video-trigger" >
      <i class="glyphicon glyphicon-facetime-video gray" ></i >
      <span > Video </span >
    </a >
  </li >
</ul >
	...
	<img src="{{ asset(Image::path('/'.json_decode($blog->config)->picture,'resizeCrop',64,64)) }}" class="dp">
      ...
      <div class="news panel" >
        <div class="post_content" >
          <div class="post_info" >
            <a href="{{URL::route('publicblog', array('name' => $blog->name))}}" > {{json_decode($blog->config)->title}} </a >
          </div >
            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="{{URL::route('publicblog', array('name' => $post->blog->name))}}"> {{json_decode($post->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->regularPost->content)->content}}</div>
                    <div class="tags">
  ...
  @elseif($post->type == 'reblogged')
    ...
    <div class="feed clearfix" >
      ...
      <div class="news panel" >
        <div class="post_content" >
          <div class="post_info" >
            <a href="{{URL::route('publicblog', array('name' => $blog->name))}}" > {{json_decode($blog->config)->title}} </a > <i class="glyphicon glyphicon-retweet"></i> <a href="{{URL::route('publicblog', array('name' => $post->rebloggedPost->originalPost->blog->name))}}"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
          </div >
            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->rebloggedPost->originalPost->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="{{URL::route('publicblog', array('name' => $post->rebloggedPost->originalPost->blog->name))}}"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->content}}</div>
                    <div class="tags">
...
<aside class="sidebar" >
  <div class="btn-group" >
    <a type="button" class="switch dropdown-toggle" data-toggle="dropdown" >
      ...
      <span class="url" >  {{URL::route('publicblog', array('name' => $defaultblog['name']))}} </span >
      <i class="glyphicon glyphicon-chevron-down" ></i >
    </a >
    <ul class="dropdown-menu" role="menu" >
      @foreach($blogs as $blog)
      <li class="blogs" >
        <a href="{{URL::to('blog/'.$blog->name)}}" class="clearfix" >
          ...
          <i class="glyphicon glyphicon-chevron-ok" ></i >
        </a >
      </li >
      @endforeach
      <li >
  ...
  <ul class="nav nav-pills nav-stacked navigation" >
    <li class="active" ><a href="#" ><i class="glyphicon glyphicon-list-alt" ></i >&nbsp; Posts</a ></li >
    <li ><a href="{{URL::route('customise', array('name' => $defaultblog['name']))}}" ><i class="glyphicon glyphicon-eye-open" ></i >&nbsp; Customise</a ></li >
  </ul >
</aside >
</section >
</div >
