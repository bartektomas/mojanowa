            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="http://{{$post->blog->name}}.rumblr.com"> {{json_decode($post->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->regularPost->content)->content}}</div>
                    <div class="tags">
  ...
  @elseif($post->type == 'reblogged')
    ...
    <div class="feed clearfix" >
      ...
      <div class="news panel" >
        <div class="post_content" >
          <div class="post_info" >
            <a href="http://{{$blog->name}}.{{Config::get('database.domain')}}" > {{json_decode($blog->config)->title}} </a > <i class="glyphicon glyphicon-retweet"></i> <a href="http://{{$post->rebloggedPost->originalPost->blog->name}}.rumblr.com"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
          </div >
            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->rebloggedPost->originalPost->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="http://{{$post->rebloggedPost->originalPost->blog->name}}.rumblr.com"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->content}}</div>
                    <div class="tags">
...
<!--          </div >-->
        ...
        <div class="post_content" >
          <div class="post_info" >
            <a href="http://{{$post->rebloggedPost->originalPost->blog->name}}.rumblr.com" > {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a > <i class="glyphicon glyphicon-retweet"></i> <a href="http://{{$post->rebloggedPost->originalPost->blog->name}}.rumblr.com"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
          </div >
          @foreach(json_decode($post->rebloggedPost->originalPost->regularPost->content)->files as $file)
            <img src="{{asset($file)}}" >
          @endforeach
